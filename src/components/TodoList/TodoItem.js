...
export const TodoItem = ({item, index, onRemoveItem}) => {
  ...
  return (
    <div className='todo-item'>
        ...
        <div className='todo-item-btn-wrapper'>
            {/* <button type='button' className='todo-item-btn'>
            ...
            <button type='button' className='todo-item-btn' onClick={handleRemoveItem}>
